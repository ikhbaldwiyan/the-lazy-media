...
function SkeletonDetail({theme}) {
  return (
    <Skeleton viewBox="0 0 100% 650" height={900} width="100%" backgroundColor={skeletonIsDark(theme, true)} foregroundColor={skeletonIsDark(theme)} >
